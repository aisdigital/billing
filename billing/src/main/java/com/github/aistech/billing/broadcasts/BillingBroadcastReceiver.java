...
package com.github.aistech.billing.broadcasts;
...
public class BillingBroadcastReceiver extends BroadcastReceiver {
    ...
    private final BillingBroadcastListener listener;

    public BillingBroadcastReceiver(BillingBroadcastListener listener) {
     ...
     */
    public interface BillingBroadcastListener {
